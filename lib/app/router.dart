...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    initialLocation: AppRouteEndpoints.login,
    redirect: (context, state) {
      final isAuthenticated = authState.value != null;
      final isAuthRoute = state.matchedLocation == AppRouteEndpoints.login ||
          state.matchedLocation == AppRouteEndpoints.signup;

      if (!isAuthenticated && !isAuthRoute) {
        return AppRouteEndpoints.login;
      }

      if (isAuthenticated && isAuthRoute) {
        return AppRouteEndpoints.home;
      }
